                  ...
                  <div className="flex items-start gap-4">
                    <div className="relative">
                      ...
                      {index < steps.length - 1 && (
                        <div className="absolute top-8 left-4 w-0.5 h-16 bg-gray-700 overflow-hiddens">
                          <motion.div
                            initial={{
        ...
        <div className="w-full md:w-2/3">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {validationError && (
                <div className="mt-4 p-3 bg-red900/30 border border-red-800 rounded-md flex items-start gap-2 text-red-300">
