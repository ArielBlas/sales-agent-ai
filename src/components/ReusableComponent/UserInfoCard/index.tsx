...
import { Attende } from "@prisma/client";
...
const UserInfoCard = ({ customer, tags, className }: Props) => {
  return (
    <div
      className={cn(
        `flex flex-col w-fit text-primary p-3 pr-10 gap-3 rounded-xl border-[0.5px] 
        border-border backdrop-blur-[20px] bg-secondary`,
        className
      )}
    >
